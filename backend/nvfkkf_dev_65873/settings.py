"""
Django settings for nvfkkf_dev_65873 project.
...
ROOT_URLCONF = 'nvfkkf_dev_65873.urls'
...
WSGI_APPLICATION = 'nvfkkf_dev_65873.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "nvfkkf_dev_65873 API",
    "DESCRIPTION": "API documentation for nvfkkf_dev_65873 App",
    "VERSION": "v1",
}
